...
public class ModuleExample extends Module {
    ...
    public ModuleExample() {
        super(Addon.DBK, "world-origin", "An example module that highlights the center of the world.");
    }

    /**
     * Example event handling method.
     * Requires {@link Addon#getPackage()} to be setup correctly, otherwise the game will crash whenever the module is enabled.
     */
    @EventHandler
